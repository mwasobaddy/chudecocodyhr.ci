                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
								...
								?>
                                 <img class="img-profile rounded-circle" style="width:100%; height:100%"
									...
									?>">
                                <a class="dropdown-item" href="<?php echo base_url('index.php/espaceagent/monprofil');?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Mon profil
                                </a>
                                 <a class="dropdown-item" href="<?php echo base_url('index.php/espaceagent/changepwd');?>">
