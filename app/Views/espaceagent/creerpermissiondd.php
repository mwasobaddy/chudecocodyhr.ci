...
<div class="container-fluid"> 
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Configuration -> Permission jour à jour</h1>
...
helper('form');
if(isset($lidpermissiondd)) {
  echo form_open('espaceagent/editpermissiondd/'.$lidpermissiondd, 'enctype="multipart/form-data"');
} else {
  echo form_open('espaceagent/creerpermissiondd', 'enctype="multipart/form-data"');
}
?>
