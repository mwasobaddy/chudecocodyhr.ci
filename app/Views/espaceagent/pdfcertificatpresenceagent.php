...
echo datefr(utf8_encode(strftime("%d %B %G", strtotime(date("j F Y"))))); ?>
      ...
      <div class="field">
        ...
        <div class="field">
          <h3>Sous-Directeur:.......................................................................</h3>
        </div>
        <div class="field">
          <h3>Et:...................................................................................</h3>
        </div>
        <div class="field">
          <h3>Directeur de l'Administration et des Finances :.........................................</h3>
        </div>
        <div class="field">
          <h3>Certifions que Monsieur/Madame/Mademoiselle : <?php echo $lagent->nom; ?></h3>
        </div>
        <div class="field">
        ...
        <div class="field">
          <h3 style="line-height: 50px;">Mise à la disposition du CHU de Cocody par note N<sup>◦</sup><?php if(isset($_POST['numa'])) { echo htmlentities(addslashes($_POST['numa'])); } ?> du <?php if(isset($_POST['datea'])) { echo htmlentities(addslashes($_POST['datea'])); } ?> du Ministère de la Santé, de l'Hygiène Publique et de la Coverture Maladie Universelle et affecté(e) par note de service N<sup>◦</sup><?php if(isset($_POST['numb'])) { echo htmlentities(addslashes($_POST['numb'])); } ?> en date du  <?php if(isset($_POST['dateb'])) { echo htmlentities(addslashes($_POST['dateb'])); } ?> de Monsieur le Directeur Général du CHU de Cocody </h3>
        </div>
        <div class="field">
          <h3>Est effectivement présent(e) depuis le <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($leconge->datereprise)))); ?></h3>
        </div>
        ...
        <div class="row pttop2">
          <div class="col-md-6">
            <div class="vsdu text-center">
              <h3><u>Visa du Sous-Directeur</u></h3>
            </div>
          </div>
          <div class="col-md-6">
            <div class="vsdu text-center">
              <h3><u>Visa du Directeur de l'Administration<br>
                et des Finances</u></h3>
            </div>
          </div>
          <div class="nbnote">
            <p> NB : Imprimé à transmettre à la Sous-Direction des Ressources Humaines, cellule
              Gestion des Actes. porte 18 en vue de l'établissement du Certificat de prise de service. </p>
          </div>
        </div>
      </div>
    </div>
