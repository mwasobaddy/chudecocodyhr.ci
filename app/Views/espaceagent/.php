...
echo datefr(utf8_encode(strftime("%d %B %G", strtotime(date("j F Y"))))); ?></h5>
      ...
      <div class="field">
        <h3> Je soussigné, Dr. MEITE Djoussoufou, Directeur Général du Centre Hospitalier et Universitaire de Cocody, certifie que <?php echo $lagent->civilite; ?> : <?php echo $lagent->nom; ?>, matricule <?php echo $lagent->matricule; ?>, emploi <?php echo $lagent->emploi; ?>, en service au <?php echo $lagent->service; ?>, Bénéficiaire d'un congé annuel de <?php echo $leconge->duree; ?> jours,<br>
          ...
          a effectivement repris fonction le <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($leconge->datereprise)))); ?>.<br>
            <br>
          En foi de quoi, le présent certificat est établi pour servir et valoir ce que de droit. </h3>
      </div>
      <div class="field pttop">
        <div class="row">
          ...
          <div class="col-md-7 text-center">
            <h3 class="text-decoration">Dr. MEITE Djoussoufou</h3>
