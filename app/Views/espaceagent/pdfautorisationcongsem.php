...
DE L'HYGIENE PUBLIQUE ET DE LA COUVERTURE MALADIE UNIVERSELLE<br>
          ...
          <h4>BP V 13 Abidjan Fax:27 22 44 13 79<br>
            ...
            <br>
            N<sup>o</sup>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /C.H.U-C/DAF/S/DRH </h4>
        </div>
...
echo datefr(utf8_encode(strftime("%d %B %G", strtotime(date("j F Y"))))); ?>
      ...
      <div class="field">
        <h3> Le Directeur Général du Centre Hospitalier et Universitaire de Cocody autorise <?php echo $lagent->civilite; ?> : <?php echo $lagent->nom; ?>
          Matricule :<?php echo $lagent->matricule; ?>, <?php echo $lagent->emploi; ?> au service :<?php echo $lagent->service; ?> à s'absenter du 
          <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($permissiondd->jourdepart)))); ?> au <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($$permissiondd->jourarrivee)))); ?> inclus en vue de <?php echo $permissiondd->motif; ?> au/en/à <?php echo utf8_encode($permissiondd->lieu); ?>
