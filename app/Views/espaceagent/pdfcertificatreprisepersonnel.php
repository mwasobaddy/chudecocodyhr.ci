...
echo datefr(utf8_encode(strftime("%d %B %G", strtotime(date("j F Y"))))); ?></h5>
      ...
      <div class="field">
        <h3><?php echo $lagent->civilite; ?> : <?php echo $lagent->nom; ?>, matricule <?php echo $lagent->matricule; ?>, emploi <?php echo $lagent->emploi; ?>, en service au <?php echo $lagent->service; ?>, Bénéficiaire d'un congé annuel de <?php echo $leconge->duree; ?> jours,<br>
     ...
     <div class="field">
          <div class="row">
            ...
            <div class="col-md-7 text-center">
              ...
              <h4>Attache Administratif des Services Financiers option Santé</h4>
            </div>
          </div>
        </div>
