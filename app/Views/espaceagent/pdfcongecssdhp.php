      ...
      <div class="field">
        ...
        <div class="field">
          <h3 style="line-height: 45px;"> <?php echo ($lagent->civilite); ?> : <?php echo ($lagent->nom); ?><br>
            ...
            Bénéficiaire d'un congé annuel de <?php echo $leconge->duree; ?> jours, en <?php echo ($leconge->lieu); ?><br>
            au titre de l'année <?php echo (intval(substr($leconge->annee,0,4))-1); ?> conformément au planning du service,
