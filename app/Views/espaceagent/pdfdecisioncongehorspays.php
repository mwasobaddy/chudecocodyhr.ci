...
echo datefr(utf8_encode(strftime("%d %B %G", strtotime(date("j F Y"))))); ?></h5>
      ...
      <div class="decide">
        ...
        <div class="decideright">
          <h4>Un congé annuel de <?php echo utf8_encode($leconge->duree); ?> jours au titre de l'année <?php echo (intval(substr($leconge->annee,0,4))-1); ?>,<br> est accordé à <?php echo $lagent->civilite; ?> <?php echo ($lagent->nom); ?>, matricule <?php echo $lagent->matricule; ?> emploi <?php echo $lagent->emploi; ?>, en <?php echo $lagent->service; ?> du CHU de Cocody à compter du <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($leconge->datedepart)))); ?> en vue de se rendre en/au <?php echo ($leconge->lieu); ?> </h4>
        </div>
      </div>
      <div class="decide">
        <div class="decideleft">
