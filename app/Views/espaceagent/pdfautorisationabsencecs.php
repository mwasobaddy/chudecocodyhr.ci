...
DE L'HYGIENE PUBLIQUE ET DE LA COUVERTURE MALADIE UNIVERSELLE<br>
          ...
          <h4>BP V 13 Abidjan Fax:27 22 44 13 79<br>
            ...
            <br>
            N<sup>o</sup>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /CHU/C/DAF/S/DRH/TI </h4>
        </div>
      ...
      <div class="field">
        <div class="field">
          <h3>Vu la demande de l'intéressé(e) en date du <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($leconge->justificatif1)))); ?>,<br>
            Avec l'avis favorable de son Supérieur Hiérarchique, le Directeur Général du CHU de Cocody autorise : </h3>
        </div>
        <div class="field">
          <h3 style="line-height: 45px;"> <?php echo $lagent->civilite; ?> : <?php echo $lagent->nom; ?><br>
            ...
            Service : <?php echo $lagent->service; ?><br>
             à s'absenter du <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($permissiondd->jourdepart)))); ?> au <?php echo datefr(utf8_encode(strftime("%d %B %G", strtotime($permissiondd->jourarrivee)))); ?> inclus.<br>
        ...
        <div class="field">
          <div class="row">
            ...
            <div class="col-md-7 text-center">
              ...
              <h2 class="pttop3 text-decoration">M. KOFFI Asséré Kouamé</h2>
