...
echo datefr(utf8_encode(strftime("%d %B %G", strtotime(date("j F Y"))))); ?></h5>
      ...
      <div class="heading4">
        <h1>CERTIFICAT DE REPRISE DE SERVICE</h1>
      </div>
      <div class="field">
        <h3> Je soussigné, Dr. MEITE Djoussoufou, Directeur Général du Centre Hospitalier et Universitaire de Cocody, certifie que Monsieur/Madame <?php echo $lagent->civilite; ?> : <?php echo $lagent->nom; ?>, matricule <?php echo $lagent->matricule; ?>, emploi <?php echo $lagent->emploi; ?>, en service au <?php echo $lagent->service; ?>, bénéficiaire d'un stage de formation dans le cadre du Diplôme de Formation Médicale Spécialisée Approfondie (DFMSA) en................... du .......... au...............à ............., en/au ......................, a effectivement repris service le ......................<br>
          <br>
