...
echo datefr(utf8_encode(strftime("%d %B %G", strtotime(date("j F Y"))))); ?></h5>
      ...
      <div class="field">
        <h3> Je soussigné,M. KOFFI Asséré Kouamé, Directeur Général du Centre Hospitalier et Universitaire de Cocody, certifie que Monsieur/Madame <?php echo $lagent->civilite; ?> : <?php echo $lagent->nom; ?>, matricule <?php echo $lagent->matricule; ?>, emploi <?php echo $lagent->emploi; ?>, en service au <?php echo $lagent->service; ?>, Bénéficiaire d'un congé annuel de <?php echo $leconge->duree; ?> jours,<br>
