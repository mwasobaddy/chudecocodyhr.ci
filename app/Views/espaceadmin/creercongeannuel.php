...
<div class="container-fluid"> 
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Configuration -> Congé annuel</h1>
...
helper('form');
if(isset($lidcongeannuel)) {
	echo form_open('espaceadmin/editcongeannuel/'.$lidcongeannuel);
} else {
	echo form_open('espaceadmin/creercongeannuel');
}
?>
          <!---- <form> ----->
          <div class="form-row">
