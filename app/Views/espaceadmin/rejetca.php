        ...
        <div class="col-xs-12 col-sm-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php
                    helper('form');
                    echo form_open('espaceadmin/rejetca/' . $lidconge);
                    ?>
                    <!---- <form> ----->
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            <input type="hidden" class="form-control" id="IDconge"
                                   name="IDconge" <?php if (isset($lidconge)) {
                                echo 'value="' . $conge->IDconge . '"';
                            } ?> >
                            <label for="datedepart">Motif du rejet</label>
                            <input type="text" class="form-control" id="motifrejet" name="motifrejet"
                                   placeholder="motif rejet" required="required" <?php if (isset($lidconge)) {
                                echo 'value="' . $conge->motifrejet . '"';
                            } ?>>
                        </div>
