...
<?php
	...
	if(isset($lidemploi)) {
		$query = $db->query("SELECT * from emploi where IDemploi=$lidemploi"); 
		$emploi = $query->getRow();
		//print_r($direction);
	}
?>
<div class="container-fluid"> 
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Configuration -> Emploi</h1>
...
helper('form');
if(isset($lidemploi)) {
	echo form_open('espaceadmin/editemploi/'.$lidemploi);
} else {
	echo form_open('espaceadmin/creeremploi');
}
?>
          <!---- <form> ----->
          <div class="form-row">
            <div class="form-group col-md-10">
             <input type="hidden" class="form-control" id="IDemploi" name="IDemploi"   <?php   if(isset($lidemploi)) {echo 'value="'.$emploi->IDemploi.'"';} ?> >
