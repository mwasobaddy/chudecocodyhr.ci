            ...
            <div class="form-row">
              <div class="form-group col-md-4">
               ...
               <div class="form-group col-md-4"> 
                ...
                <select id="position" name="position" class="form-control">
                  <option>EN ACTIVITE</option>
                  <option>DETACHEMENT</option>
                  <option>MISE EN DISPONIBILITE</option>
                  <option>SOUS LES DRAPEAUX</option>
                </select>
              ...
              <div class="form-group col-md-4">
               <label for="motifdisponibilite">Motif position</label>
                <input type="text" class="form-control" id="motifdisponibilite" name="motifdisponibilite" value="" placeholder="Motif position">
              </div>
            </div>
