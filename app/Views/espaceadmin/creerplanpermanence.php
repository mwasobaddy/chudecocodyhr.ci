...
<div class="container-fluid"> 
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Planning -> Permanence</h1>
...
helper('form');
if(isset($lidplanpermanence)) {
	echo form_open('espaceadmin/editplanpermanence/'.$lidplanpermanence);
} else {
	echo form_open('espaceadmin/creerplanpermanence');
}
?>
 <!---- <form> ----->
          <div class="form-row">
