...
if(isset($lidarrettravail) && !isset($lidarrettravailp) && !isset($lidarrettravailr)) {
	echo form_open_multipart('espaceadmin/editarrettravail/'.$lidarrettravail);
} else {
	if(isset($lidarrettravail) && isset($lidarrettravailp)) {
		echo form_open_multipart('espaceadmin/prorogerarrettravail/'.$lidarrettravail);
	} else {
		if(isset($lidarrettravail) && isset($lidarrettravailr)) {
			echo form_open_multipart('espaceadmin/retourarrettravail/'.$lidarrettravail);
		} else {
			echo form_open_multipart('espaceadmin/creerarrettravail');
		}
	}
}
?>
