                            ...
                            <div class="col-lg-7 p-0 d-flex align-items-center justify-content-center">
                                <div class=" py-0 px-5 mb-4">
                                   ...
                                   <?php
                                        ...
                                        helper('form');
                                        echo form_open('home/checkingsuper');
                                    ...
                                    ?>
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="password" class="form-control form-control-user" id="code" name="code" placeholder="Code de validation">
                                            
                                            
                                        </div>
                                        
                                        
                                        <input type="hidden" class="form-control form-control-user" id="iddd" name="iddd" placeholder="Code de validation" value="<?php 
                                        ...
                                        <button type="submit" class="btn btn-primary mb-4"  name="go" id="go" style="width:100%">Valider mot de passe</button>
                                        
                                       <br/><br/>
                                         <a href="<?php echo base_url('/home/initpasssuper');?>">Mot de passe oublié (Réinitialiser)</a>
