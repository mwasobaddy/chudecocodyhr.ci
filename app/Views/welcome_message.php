...
<br/>
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="img/chu.jpg" alt="Logo CHU Cocody" title="Logo CHU Cocody" style="width:100%; height:100%"/></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <div class="form-group"><br/>
                                            <input type="text" class="form-control form-control-user"
                                                id="code" placeholder="CODE VALIDATION">
                                        </div>
