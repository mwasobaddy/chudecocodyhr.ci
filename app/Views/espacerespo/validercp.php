...
echo view('toast');
 ?>
    ...
    <div class="card-body">
      ...
      Avant de valider une demande, rassurez-vous d'avoir effectué les modifications nécessaires dans l'espace d'attribution de planning :  <a href="<?php echo base_url('/espacerespo/attribuerplanpermanence');?>"> ICI </a><br/><br/>
