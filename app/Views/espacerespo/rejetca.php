...
helper('form');
	...
	echo form_open('espacerespo/rejetca/'.$lidconge);
...
?>
          ...
          <div class="form-row">
            ...
            <input type="hidden" class="form-control" id="IDconge" name="IDconge"   <?php   if(isset($lidconge)) {echo 'value="'.$conge->IDconge.'"';} ?> >
            
          <label for="datedepart">Motif du rejet</label>
              <input type="text" class="form-control" id="motifrejet" name="motifrejet"  placeholder="motif rejet" required="required" <?php   if(isset($lidconge)) {echo 'value="'.$conge->motifrejet.'"';} ?>>
