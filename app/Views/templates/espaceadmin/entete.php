...
<head>
    ...
    <link href="<?php echo base_url('vendor/datatables/dataTables.bootstrap4.min.css');?>" rel="stylesheet">
     ...
     <link href="<?php echo base_url('export/jquery.dataTables.min.css');?>" rel="stylesheet">
      <link href="<?php echo base_url('export/buttons.dataTables.min.css');?>" rel="stylesheet">
